...
var serviceMethods = map[string]kitex.MethodInfo{
	"ReplFinishNotify": kitex.NewMethodInfo(
		replFinishNotifyHandler,
		newNodeServiceReplFinishNotifyArgs,
		newNodeServiceReplFinishNotifyResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"IsAlive": kitex.NewMethodInfo(
		isAliveHandler,
		newNodeServiceIsAliveArgs,
		newNodeServiceIsAliveResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"RegisterSlave": kitex.NewMethodInfo(
		registerSlaveHandler,
		newNodeServiceRegisterSlaveArgs,
		newNodeServiceRegisterSlaveResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"PSyncReq": kitex.NewMethodInfo(
		pSyncReqHandler,
		newNodeServicePSyncReqArgs,
		newNodeServicePSyncReqResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"PSyncReady": kitex.NewMethodInfo(
		pSyncReadyHandler,
		newNodeServicePSyncReadyArgs,
		newNodeServicePSyncReadyResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"OpLogEntry": kitex.NewMethodInfo(
		opLogEntryHandler,
		newNodeServiceOpLogEntryArgs,
		newNodeServiceOpLogEntryResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"SendSlaveof": kitex.NewMethodInfo(
		sendSlaveofHandler,
		newNodeServiceSendSlaveofArgs,
		newNodeServiceSendSlaveofResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"Info": kitex.NewMethodInfo(
		infoHandler,
		newNodeServiceInfoArgs,
		newNodeServiceInfoResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"GetAllNodesInfo": kitex.NewMethodInfo(
		getAllNodesInfoHandler,
		newNodeServiceGetAllNodesInfoArgs,
		newNodeServiceGetAllNodesInfoResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"Ping": kitex.NewMethodInfo(
		pingHandler,
		newNodeServicePingArgs,
		newNodeServicePingResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
}
...
var (
	nodeServiceServiceInfo                = NewServiceInfo()
	nodeServiceServiceInfoForClient       = NewServiceInfoForClient()
	nodeServiceServiceInfoForStreamClient = NewServiceInfoForStreamClient()
)
...
func serviceInfoForStreamClient() *kitex.ServiceInfo {
	return nodeServiceServiceInfoForStreamClient
}

// for client
func serviceInfoForClient() *kitex.ServiceInfo {
	return nodeServiceServiceInfoForClient
}
...
func isAliveHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	_ = arg.(*node.NodeServiceIsAliveArgs)
...
func infoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	_ = arg.(*node.NodeServiceInfoArgs)
...
func pingHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	_ = arg.(*node.NodeServicePingArgs)
